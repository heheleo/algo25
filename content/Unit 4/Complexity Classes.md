...
## P (Polynomial Time)
P contains all decision problems that are [[Limits of Computability#Tractable problems|tractable]] - that is, the problem has a solution that can be found in polynomial time. Polynomial-Time problems are [[Deterministic algorithm|deterministic algorithms]]. 
...
NP contains all decision problems that are [[Limits of Computability#Soft Limit of Computability|intractable]]. 
